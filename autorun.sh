...
chmod +x setresolution.sh autorefresh.sh hashgenerator.sh loopsign.sh reboot.sh systemupdate.sh hidecursor.sh loopsignsplash.sh # Adjust filenames as needed
./setresolution.sh
