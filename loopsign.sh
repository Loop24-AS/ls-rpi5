...
chromium-browser --disable-media-stream --start-maximized --start-fullscreen --disable-desktop-notifications --no-first-run --user-agent="$FINAL_UA" https://play.loopsign.eu/hash/$HASH
